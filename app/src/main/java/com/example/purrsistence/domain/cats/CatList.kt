...
object CatList {
    ...
    val cats = listOf(
        ShopItem(
            ...
            0,
            R.drawable.cat_idle,
            SpriteSheetData(columns = 4, rows = 3, totalFrames = 10, frameDurationMs = 400L)
        ),
        ShopItem("cat_2", "Black Cat", 13, R.drawable.cat_black),
        ShopItem("cat_3", "Creme Cat", 20, R.drawable.cat_creme),
        ShopItem("cat_4", "Brown Cat", 10, R.drawable.cat_brown), ShopItem("cat_5", "Gray Cat", 15, R.drawable.cat_darkgray),
